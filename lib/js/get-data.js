...
function plot_observation(observation_data)
{
    ...
    var xScale = d3.scaleTime()
        .domain([get_d3_date_from_iso_datetime(observation_data['data'][0].time), 
                get_d3_date_from_iso_datetime(observation_data['data'][num_observations - 1].time)])
        .range([0, width]);
    ...
    var obs_line = d3.line()
                    .x(function(data, index) { return xScale(get_d3_date_from_iso_datetime(data.time));})
