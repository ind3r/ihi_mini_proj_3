...
function plot_observation(observation_data)
{
    ...
    const max_data_point = d3.max(observation_data['data'], function(data){return data.value;}) + 50;
    // Y scale and axis - observation values
    var yScale = d3.scaleLinear()
                .domain([0, max_data_point])
                .range([height, 0]);
    ...
    if (observation_data.normal_range.max < 0)
                observation_data.normal_range.max = max_data_point;
